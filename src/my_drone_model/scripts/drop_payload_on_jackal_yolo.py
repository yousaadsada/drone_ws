...
class ManualRollControl:
    ...
    def subcribe_quadrotor_msg_callback(self, msg):
        ...
        #     self.ref_x = self.jackal_state.x
        #     self.ref_y = self.jackal_state.y
        #     self.ref_x_speed = 0.0
        #     self.ref_y_speed = 0.0
        
            # self.ref_x_speed = self.jackal_state.x_speed
            # self.ref_y_speed = self.jackal_state.y_speed
    ...
    # def subcribe_jackal_pos_callback(self, msg):
    #     if msg.target == True:
    ...
    #         dx = self.jackal_state.x - self.current_drone_state.x
    #         dy = self.jackal_state.y - self.current_drone_state.y

    #         panel_distance = math.sqrt(dx**2 + dy**2)
    #         vertical_distance = self.current_drone_state.z - self.jackal_state.z
    ...
    #         if self.ref_camera_pitch < 0.9 * math.pi / 2:
